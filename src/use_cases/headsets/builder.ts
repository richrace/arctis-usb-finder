...
import ArctisNovaEliteBuilder from './arctis_nova_elite_builder';
import ArctisNovaProWirelessBuilder from './arctis_nova_pro_wireless_builder';
  ...
  constructor(private deviceHash: DeviceToHeadphone) {
    ...
    switch (knownHeadphone.productId) {
      ...
      case KnownHeadphone.Arctis_Nova_Elite_ProductID:
        this.specificBuilder = new ArctisNovaEliteBuilder();
        break;
    }
  }
